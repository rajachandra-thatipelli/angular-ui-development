...
export const BOOKS: Book[] = [
  ...
  {
    isbn: 9781849510004,
    title: 'JavaScript Testing Beginner\'s Guide',
    authors: 'Yuxian',
  ...
  },
  {
    ...
    authors: 'Narayan Prusty',
    published: 'February 2017',
    description: 'Blockchain is a distributed database that maintains a continuously growing list of data records secured from tampering and revision. Every user is allowed to connect to the network, send new transactions to it, verify transactions, and create new blocks, making it permission-less.',
    coverImage: 'https://d1ldz4te4covpm.cloudfront.net/sites/default/files/imagecache/ppv4_main_book_cover/B05955_MockupCover.jpg'
  },
  {
    isbn: 9781849692380,
